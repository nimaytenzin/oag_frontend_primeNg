...
@Component({
    selector: 'app-public-list-billed-legislations',
    standalone: true,
    imports: [
        PaginatorModule,
        TableModule,
    ...
    templateUrl: './public-list-billed-legislations.component.html',
    styleUrl: './public-list-billed-legislations.component.scss',
})
export class PublicListBilledLegislationsComponent {
    ...
    constructor(
        ...
        this.titleService.setTitle('Bills ');
    }
    ...
    private updateSearchTitle(): void {
        this.searchTitle =
            this.selectedAlphabet === this.alphabets[0]
                ? 'Bills'
                : `Bills starting with ${this.selectedAlphabet}`;
    }
