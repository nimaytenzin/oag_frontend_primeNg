...
@Component({
    selector: 'app-public-list-repealed-legislations',
    standalone: true,
    imports: [
        PaginatorModule,
        TableModule,
    ...
    templateUrl: './public-list-repealed-legislations.component.html',
    styleUrl: './public-list-repealed-legislations.component.scss',
})
export class PublicListRepealedLegislationsComponent
    implements OnInit, AfterViewInit
{
    ...
    pageTitle = 'Repealed Legislations';
    searchTitle: string;
    ...
    constructor(
        ...
        this.titleService.setTitle('Repealed Legislations');
    }
    ...
    private updateSearchTitle(): void {
        this.searchTitle =
            this.selectedAlphabet === this.alphabets[0]
                ...
                : `Repealed Legislations starting with ${this.selectedAlphabet}`;
    }
