...
@Component({
  selector: 'app-public-list-ammended-legislations',
  standalone: true,
  imports: [
    PaginatorModule,
    TableModule,
  ...
  templateUrl: './public-list-ammended-legislations.component.html',
  styleUrl: './public-list-ammended-legislations.component.scss'
})

export class PublicListAmmendedLegislationsComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    this.titleService.setTitle('Amended Legislation');
  }
  ...
  private handlePagination(): void {
    ...
    this.legislationDataService
      .PublicGetAmendedLegislationsPaginated(queryParams)
      .subscribe((res) => {
  ...
  private updateSearchTitle(): void {
    this.searchTitle =
      this.selectedAlphabet === this.alphabets[0]
        ...
        : `Amended Legislations starting with ${this.selectedAlphabet}`;
  }
