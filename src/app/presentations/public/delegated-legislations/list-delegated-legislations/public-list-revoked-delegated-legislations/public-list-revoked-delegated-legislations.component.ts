...
@Component({
    ...
    templateUrl: './public-list-revoked-delegated-legislations.component.html',
    styleUrl: './public-list-revoked-delegated-legislations.component.scss',
})
export class PublicListRevokedDelegatedLegislationsComponent {
    ...
    pageTitle = 'Revoked Delegated Legislations';
    searchTitle: string;
    ...
    private updateSearchTitle(): void {
        this.searchTitle =
            this.selectedAlphabet === this.alphabets[0]
                ? 'Revoked Delegated Legislations'
                : `Revoked Delegated Legislations starting with ${this.selectedAlphabet}`;
    }
