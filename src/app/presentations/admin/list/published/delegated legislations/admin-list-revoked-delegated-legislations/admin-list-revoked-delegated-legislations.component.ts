...
@Component({
    selector: 'app-admin-list-revoked-delegated-legislations',
    templateUrl: './admin-list-revoked-delegated-legislations.component.html',
    styleUrls: ['./admin-list-revoked-delegated-legislations.component.css'],
    standalone: true,
    imports: [
        PaginatorModule,
        TableModule,
...
export class AdminListRevokedDelegatedLegislationsComponent implements OnInit {
    ...
    pageTitle = 'Published Revoked Delegated Legislations';
    searchTitle: string;
    ...
    private handlePagination(): void {
        ...
        this.delegatedLegislationDataService
            .AdminGetPublishedRevokedDelegatedLegislationsPaginated(queryParams)
            .subscribe((res) => {
                console.log('PAGINATED Revoked DL', res);
    ...
    private updateSearchTitle(): void {
        this.searchTitle =
            this.selectedAlphabet === this.alphabets[0]
                ? 'Published Revoked Delegated Legislations'
                : `Published Revoked Delegated Legislations starting with ${this.selectedAlphabet}`;
    }
