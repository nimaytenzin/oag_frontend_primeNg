...
@Component({
    selector: 'app-admin-list-amendments',
    standalone: true,
    imports: [
        PaginatorModule,
        TableModule,
    ...
    templateUrl: './admin-list-amendments.component.html',
    styleUrl: './admin-list-amendments.component.scss',
})
export class AdminListAmendmentsComponent {
    ...
    pageTitle = 'Published Amendments';
    searchTitle: string;
    ...
    private updateSearchTitle(): void {
        this.searchTitle =
            this.selectedAlphabet === this.alphabets[0]
                ...
                : `Published Amendments starting with ${this.selectedAlphabet}`;
    }
