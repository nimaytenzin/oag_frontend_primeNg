...
@Component({
    selector: 'app-admin-list-conventions',
    standalone: true,
    imports: [
        PaginatorModule,
        TableModule,
    ...
    templateUrl: './admin-list-conventions.component.html',
    styleUrl: './admin-list-conventions.component.scss',
})
export class AdminListConventionsComponent {
    ...
    pageTitle = 'Published Conventions';
    searchTitle: string;
    ...
    private updateSearchTitle(): void {
        this.searchTitle =
            this.selectedAlphabet === this.alphabets[0]
                ...
                : `Published Conventions starting with ${this.selectedAlphabet}`;
    }
    ...
    viewLegislation(legislation: LegislationDto) {
        this.router.navigate(['admin/legislations/' + legislation.id]);
    }
}
